...
describe 'User visits homepage' do 
  ...
  it 'and see only available registered lodges' do  ###### VÊ SÓ O NOME E A CIDADE --> clica vê detalhes, sem cnpj e razão social
    #Arrange
  ...
  # it 'and sees two blocks of available registered lodges' do 
  #   #Arrange
  #   owner1 = Owner.create!(name: 'Rogério Sampaio', email: 'rsampaio123@gmail.com', password: '123456')
  #   owner2 = Owner.create!(name: 'Carla Mendonça', email: 'carsampa@gmail.com', password: '123456')
  ...
  #   Lodge.create!(name: 'Recanto do Sol', headline: 'Serra do Cipó', full_address: 'Rua das Emas, 13, Belo Horizonte - MG, Brasil. CEP: 77345-000', 
  #                 description: 'Pousada com vista para a serra', bedrooms: 6, max_guests: 20, pets: false, 
  #                 disabled_facilities: 'Rampas de acesso', check_in: '17:00', check_out: '14:00', ##############status: 'available', 
  #                 email: 'recantodosol@gmail.com', phone_number: '38985694512', corporate_name: 'Fernandes e Oliveira LTDA',
  #                 cnpj: '91241057000138', payment_method: "Cartão de débito, Dinheiro e Pix", 
  #                 policies: 'Silêncio a partir das 22h. Proibido visitas.', owner: owner2)
  #   Lodge.create!(name: 'Jardim de espelhos', headline: 'Reserva Natural', full_address: 'Alameda Tuiuiú, 58, Bonito - MS, Brasil. CEP: 58961-222', 
  #                 description: 'Pousada em contato com a natureza', bedrooms: 15, max_guests: 45, pets: false, 
  ...
  #   expect(page).to have_content 'Jardim dos Espelhos' 
  # end 
