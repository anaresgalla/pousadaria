...
feature 'User searches for a logde' do
  context 'by its brand name' do
    ...
    #Act
    visit root_path
    fill_in 'Busca:', with: 'Morada do Curupira'
    click_on 'Pesquisar'

    expect(current_path).to eq search_path
    expect(page).to have_content 'Morada do Curupira'
    expect(page).not_to have_content 'Jardim de Espelhos'
