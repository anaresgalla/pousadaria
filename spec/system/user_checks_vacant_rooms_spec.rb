...
describe 'User checks vacant rooms of a lodge' do
  ...
  #   click_on 'Pérola Negra'
  #   click_on 'Reservar'
  #   fill_in 'Check In', with: 'DATA'
  #   fill_in 'Check Out', with: 'DATA'
  #   fill_in 'Número de Hóspedes', with: 'xxxxx'
  ...
  #   #Assert
  #   expect(page).to have_content 'Desculpe, mas o quarto não está disponível.'
  #   expect(page).not_to have_content 'O quarto está disponível.'
  #   expect(current_page).to eq RESERVATIONPATH
  # end
