...
describe 'User visits homepage' do 
  ...
  it 'and see only available registered lodges' do  
    ...
    owner2 = Owner.create!(name: 'Carla Mendonça', email: 'carsampa@gmail.com', 
                           password: '123456')
    Lodge.create!(name: 'Pousada do Mar', address: 'Avenida Beira Mar, 1500', 
    ...
    Lodge.create!(name: 'Recanto do Sol', address: 'Rua das Emas, 13', 
  ...
  it 'and sees the three most recent logdes separated from the others' do
    ...
    owner2 = Owner.create!(name: 'Carla Mendonça', email: 'carsampa@gmail.com', 
                           password: '123456')
    owner3 = Owner.create!(name: 'Márcia Gomes', email: 'mrsgomes@gmail.com', 
                           password: '123456')
    owner4 = Owner.create!(name: 'Laís Nunes', email: 'lanunes@gmail.com', 
                           password: '123456')
    ...
    lodge2 = Lodge.create!(name: 'Recanto do Sol', address: 'Rua das Emas, 13', 
                           ...
                           payment_method: "Cartão de débito, Dinheiro e Pix", 
                           policies: 'Silêncio a partir das 22h. Proibido visitas.', owner: owner2)
    lodge3 = Lodge.create!(name: 'Jardim de espelhos', address: 'Alameda Tuiuiú, 58', 
                           neighborhood: 'Horizonte', city: 'Bonito', state: 'MS', 
                           country: 'Brasil', zip_code: '58961-222', 
                           description: 'Pousada em contato com a natureza', 
                           bedrooms: 15, max_guests: 45, pets: 'Não', 
                           disabled_facilities: 'Rampas de acesso, banheiros adaptados', 
                           check_in: '18:00', check_out: '13:00', status: 'Ativa', 
                           email: 'jardimdosespelhos@gmail.com', phone_number: '59987458523', 
                           corporate_name: 'Pantanal Resorts LTDA', cnpj: '57568391000162', 
                           payment_method: "Cartão de crédito, Cartão de débito e Dinheiro", 
                           policies: 'Silêncio a partir das 22h. Proibido visitas. Proibido fumar no local. 
                           Não aceitamos cheques.', owner: owner3)
    lodge4 = Lodge.create!(name: 'Morada do Curupira', address: 'Avenida Solimões, 789', 
                           neighborhood: 'Seringueiras', city: 'Manaus', state: 'AM', 
                           country: 'Brasil', zip_code: '19845-666', 
                           description: 'Pousada rodeada pela maior floresta do mundo', 
                           bedrooms: 12, max_guests: 44, pets: 'Sim', 
                           disabled_facilities: 'Rampas de acesso, banheiros adaptados', 
                           check_in: '18:00', check_out: '13:00', status: 'Ativa', 
                           email: 'moradadocurupira@gmail.com', phone_number: '75984596231', 
                           ...
                           Não aceitamos cheques.', owner: owner4)
  ...
  it 'and sees the cities menu in alphabetical order' do
    ...
    lodge3 = Lodge.create!(name: 'Jardim de espelhos', address: 'Alameda Tuiuiú, 58', 
                           ...
                           corporate_name: 'Pantanal Resorts LTDA', cnpj: '57568391000162', 
                           payment_method: "Cartão de crédito, Cartão de débito e Dinheiro", 
                           policies: 'Silêncio a partir das 22h. Proibido visitas. 
                           Proibido fumar no local. Não aceitamos cheques.', owner: owner3)
    lodge4 = Lodge.create!(name: 'Morada do Curupira', address: 'Avenida Solimões, 789',  
                           neighborhood: 'Seringueiras', city: 'Manaus', state: 'AM', 
                           country: 'Brasil', zip_code: '19845-666', 
                           description: 'Pousada rodeada pela maior floresta do mundo', 
  ...
  it 'and sees the logdes when clicking on the name of the city' do
    ...
    lodge3 = Lodge.create!(name: 'Jardim de espelhos', address: 'Alameda Tuiuiú, 58', 
                           ...
                           corporate_name: 'Pantanal Resorts LTDA', cnpj: '57568391000162', 
                           payment_method: "Cartão de crédito, Cartão de débito e Dinheiro", 
                           policies: 'Silêncio a partir das 22h. Proibido visitas. Proibido 
                           fumar no local. Não aceitamos cheques.', owner: owner3)
    lodge4 = Lodge.create!(name: 'Morada do Curupira', address: 'Avenida Solimões, 789', 
                           neighborhood: 'Seringueiras', city: 'Manaus', state: 'AM', 
                           country: 'Brasil', zip_code: '19845-666', 
                           description: 'Pousada rodeada pela maior floresta do mundo', 
  ...
  it 'and sees the logdes from a city in alphabetical order' do
    ...
    owner3 = Owner.create!(name: 'Márcia Gomes', email: 'mrsgomes@gmail.com', 
                           password: '123456')
    lodge1 = Lodge.create(name: 'Pousada do Mar', address: 'Avenida Beira Mar, 1500', 
                          neighborhood: 'Coqueiros', city: 'Belo Horizonte', state: 'ES', 
                          country: 'Brasil', zip_code: '12345-985', 
                          description: 'Pousada em frente à praia', bedrooms: 5, 
                          max_guests: 12, pets: 'Sim', disabled_facilities: 'Menu em Braile', 
                          check_in: '15:00', check_out: '12:00', status: 'Ativa', 
    ...
    lodge2 = Lodge.create!(name: 'Recanto do Sol', address: 'Rua das Emas, 13', 
                           ...
                           policies: 'Silêncio a partir das 22h. Proibido visitas.', owner: owner2)
    lodge3 = Lodge.create!(name: 'Jardim de espelhos', address: 'Alameda Tuiuiú, 58', 
                           neighborhood: 'Horizonte', city: 'Belo Horizonte', state: 'MS', 
                           country: 'Brasil', zip_code: '58961-222', 
                           description: 'Pousada em contato com a natureza', 
                           bedrooms: 15, max_guests: 45, pets: 'Não', 
                           disabled_facilities: 'Rampas de acesso, banheiros adaptados', 
                           ...
                           corporate_name: 'Pantanal Resorts LTDA', cnpj: '57568391000162', 
                           payment_method: "Cartão de crédito, Cartão de débito e Dinheiro", 
                           policies: 'Silêncio a partir das 22h. Proibido visitas. Proibido fumar 
                           no local. Não aceitamos cheques.', owner: owner3)
